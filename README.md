...
## Template for 35xx/40xx console (Create on my [muOS Knulli Termi.Redacted v2 theme](https://github.com/chronoss09/Theme-muOS-Goose/releases/tag/knulli))
<table align="center">
<tr>
...
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="Two Mix Layout NDS" src="https://github.com/user-attachments/assets/f4d1b0fc-6d44-48d4-8788-165ac2ab9c33" />
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/640x480/Two%20Mix%20Layout%20NDS%20(XML).muxapp">
        <b>Two Mix Layout NDS</b></a><br/>
        <small><i>For best use with NDS games</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="Two Mix Layout all" src="https://github.com/user-attachments/assets/3a36e3c0-00a8-41a9-8c52-900475d70da5"/>
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/640x480/Two%20Mix%20Layout%20all%20(XML).muxapp">
        <b>Two Mix Layout all</b></a><br/>
        <small><i>Compatible with all game section</i></small><br/>
        </td>
</tr>
<tr>
<td align="center" valign="top" width="22.22%">
...
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="Two Mix Layout long cover with cartridge" src="https://github.com/user-attachments/assets/f3cf1dd4-09c6-4bc2-bcb5-6f1f7e7ef781" />      
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/640x480/Two%20Mix%20Layout%20long%20cover%20with%20cartridge%20(XML).muxapp">
        <b>Two Mix Layout long cover with cartridge</b></a><br/>
        <small><i>For long box like Genesis</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="Two Mix Layout long cover with logo" src="https://github.com/user-attachments/assets/91cfae78-1290-4252-920b-cdfa438be5a8" />
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/640x480/Two%20Mix%20Layout%20long%20cover%20with%20logo%20(XML).muxapp">
        <b>Two Mix Layout long cover with logo</b></a><br/>
        <small><i>Long box with logo on right below the list of games</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="Two Mix Layout small cover with cartridge" src="https://github.com/user-attachments/assets/7274c2da-e8ed-488c-b9d0-0d212d2b885e" />
...
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="New Arcade Cabinet overlay" src="https://github.com/user-attachments/assets/71b7beeb-0542-4e2c-b731-16157e8e1204" />
...
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="640" height="480" alt="New Arcade Cabinet wt overlay" src="https://github.com/user-attachments/assets/77ee7f29-ec68-4515-9bea-6b38dd7a9206" />        
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/640x480/New%20Arcade%20Cabinet%20wt%20overlay%20(XML).muxapp">
        <b>New Arcade Cabinet<br/>without overlay</b></a><br/>
        <small><i>Goog for Arcades games but you can use it anywhere too</i></small><br/>
        </td>
</tr>
</table>
...
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cartridge (long) TSP" src="https://github.com/user-attachments/assets//ead7ebee-48f3-44fb-8d5a-5232af89e4a5" />
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cartridge%20(long)%20TSP.muxapp">
        <b>Cartridge (long)</b></a><br/>
        <small><i>Usefull for NDS, GB and GBC cartridge</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cartridge (small) TSP" src="https://github.com/user-attachments/assets/3871300f-cb2b-453b-93c8-cc2c8abb7025" />        
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cover%202D%20(small)%20TSP.muxapp">
        <b>Cartridge (small)</b></a><br/>
        <small><i>Usefull for GBA cartridge and maybe over small cartridge</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cover 2D (small) TSP" src="https://github.com/user-attachments/assets/8fb993f6-862f-4db0-84ff-9f1abafa6d7a" />
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cover%202D%20(small)%20TSP.muxapp">
        <b>Cover 2D (small)</b></a><br/>
        <small><i>Biggest 2D box for litlle cover game</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cover 2D_Cartridge (long) TSP" src="https://github.com/user-attachments/assets/b02c199a-023e-4399-b132-0c51284c1afd"/>
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cover%202D_Cartridge%20(long)%20TSP.muxapp">
        <b>Cover 2D_Cartridge (long)</b></a><br/>
        <small><i>Compatible MG and other log box</i></small><br/>
        </td>
</tr>
<tr>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cover 2D_Cartridge (PSP) TSP" src="https://github.com/user-attachments/assets/17b7e74d-8d2c-4755-9781-89b934476965" />
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cover%202D_Cartridge%20(PSP)%20TSP.muxapp">
        <b>Cover 2D_Cartridge (PSP)</b></a><br/>
        <small><i>2D box and UMD for PSP</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cover 2D_Cartridge (small) TSP" src="https://github.com/user-attachments/assets/a626db8b-b5d7-45f8-a5d5-d927490d50d9" />        
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cover%202D_Cartridge%20(small)%20TSP.muxapp">
        <b>Cover 2D_Cartridge (small)</b></a><br/>
        <small><i>2D box and cartridge for SNES game</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
        <img width="1280" height="720" alt="Cover 2D (small) TSP" src="https://github.com/user-attachments/assets/4d066605-e544-40f2-9657-a877154276f2" />
        <a href="https://github.com/chronoss09/Scrappy-XML-Template/blob/main/TSP/Alekfull-NX/Cover%203D%20(GB_GBA)%20TSP.muxappp">
        <b>Cover 3D (GB_GBA)</b></a><br/>
        <small><i>2D box for GB, GBC and GBA game</i></small><br/>
        </td>
<td align="center" valign="top" width="22.22%">
        <br/>
